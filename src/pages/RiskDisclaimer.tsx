  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="fluid-h1 mb-8">Risk Disclaimer</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-6">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Understanding the Risks</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Past Performance</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Educational Content Only</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Seek Professional Advice</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Regulatory Information</h2>
            <p className="fluid-body">
