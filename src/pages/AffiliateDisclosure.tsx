  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="fluid-h1 mb-8">Affiliate Disclosure</h1>
        
        <div className="prose prose-lg max-w-none space-y-6">
          <section>
            <h2 className="fluid-h2 mb-4">Affiliate Relationships</h2>
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Partner Broker: Exness</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Our Commitment to Transparency</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Editorial Independence</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">No Additional Cost to You</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">FTC Compliance</h2>
            <p className="fluid-body">
