  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="fluid-h1 mb-8">Terms of Use</h1>
        
        <div className="prose prose-lg max-w-none space-y-6">
          <section>
            <h2 className="fluid-h2 mb-4">Educational Purpose</h2>
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Risk Acknowledgment</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">No Guarantees</h2>
            <p className="fluid-body">
          ...
          <section>
            <h2 className="fluid-h2 mb-4">Limitation of Liability</h2>
            <p className="fluid-body">
