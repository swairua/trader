...
export function Navigation() {
  ...
  return (
    <nav aria-label="Main" className="sticky top-0 z-50 w-full border-b border-border/30 bg-background/90 dark:bg-white/20 backdrop-blur-sm supports-[backdrop-filter]:bg-background/60">
